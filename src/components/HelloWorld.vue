...
var config = {
  apiKey: 'AIzaSyBiLf89vgElJaYLwG8zbTkoqSt9xmRwhGI',
  authDomain: 'testfirebase-6529a.firebaseapp.com',
  databaseURL: 'https://testfirebase-6529a.firebaseio.com',
  projectId: 'testfirebase-6529a',
  storageBucket: 'testfirebase-6529a.appspot.com',
  messagingSenderId: '62637283111'
}
